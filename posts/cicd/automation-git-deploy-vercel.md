...
[이전 포스트](https://hippolog.vercel.app/posts/CICD/automation3)에서는 **PR 생성** 및 **Github Action Trigger** 를 통한 테스트 Action 실행과 Slack 으로 연동해서 최종 **Reporting** 하는 방법까지 알아보았습니다.
